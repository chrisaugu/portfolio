      ...
      <>
        <nav className="navbar">
          <ul className="link-group">
            <li className="link active"><Link href="/">home</Link></li>
            <li className="link active"><Link href="/about">about</Link></li>
            <li className="link active"><Link href="/projects">projects</Link></li>
            <li className="link active"><Link href="/contact">contact</Link></li>
          </ul>
        </nav>
